/**
 * Tela "Minhas Estatísticas" — painel pessoal do tutor.
 * Arquivo destino: app/(app)/stats.tsx
 *
 * Versão enxuta: só dados úteis pro tutor, sem jargão técnico.
 * Identidade Elite (dark + Ametista + Jade).
 */
